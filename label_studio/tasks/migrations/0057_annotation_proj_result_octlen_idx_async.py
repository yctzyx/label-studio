...
sql_pg_drop = 'DROP INDEX CONCURRENTLY IF EXISTS annotation_proj_result_octlen_idx;'

sql_mysql_create = (
    'CREATE INDEX `annotation_proj_result_octlen_idx` '
    'ON `task_completion` (`project_id`);'
)
sql_mysql_drop = (
    'DROP INDEX `annotation_proj_result_octlen_idx` ON `task_completion`;'
)
